...
@section('content')
    <form method="post" action="{{ route('mis.settings.update') }}" enctype="multipart/form-data" class="max-w-3xl space-y-8 text-sm">
        @csrf @method('patch')
    ...
    <section class="mis-google-calendar-card mt-8 max-w-3xl rounded-2xl border border-gray-200 bg-white/90 p-4 space-y-3 text-sm">
